 ...
 <div class="container">
  ...
  <form id="getAttendance">
    ...
    <div class="form-group">
      ...
      <input type="text" class="form-control" name="code" placeholder="Eg - CCB-216">
      <span class="help-block">DDD-NNN where D : Department , N : Number</span>
    </div>
    <div class="form-group">
      <label>Roll Number</label>
      <input type="text" class="form-control" name="roll" placeholder="Eg - 262/CA/12">
   ...
   <!-- FOOTER -->
      <footer style="background:; height:;">
        <button type="button" class="pull-right" style="margin-right: 40px; margin-bottom: 40px"><a href="#">Back to top</a></button>
