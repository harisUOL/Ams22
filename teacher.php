        ...
        <div class="modal-content">
          ...
          <hr>
            <div id="add_class_form">
              ...
              <input class="form-control" name="code" placeholder="Code , Eg : CCB-322">
              ...
              <input class="form-control" name="start" placeholder="Starting Roll Number (Eg. 201/CA/12)">
              <input class="form-control" name="end" placeholder="Ending Roll Number (Eg. 265/CA/12)">
